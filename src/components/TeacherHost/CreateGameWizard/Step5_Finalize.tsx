        ...
        <div className="space-y-6 text-gray-700">
            ...
            <div className="mt-8 flex justify-between">
                ...
                <button
                    ...
                    onClick={onFinalize}
                    disabled={isSubmitting}
                    className="flex items-center gap-2 bg-green-600 text-white font-bold py-3 px-8 rounded-lg hover:bg-green-700 transition-colors shadow-lg focus:outline-none focus:ring-2 focus:ring-green-500 focus:ring-offset-2 disabled:opacity-70"
                >
                    {isSubmitting ? (
                    ...
                    {isSubmitting ? 'Finalizing...' : 'Finalize & Start Game'}
                </button>
            </div>
        </div>
    );
