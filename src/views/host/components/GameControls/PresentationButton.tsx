// src/views/host/components/GameControls/PresentationButton.tsx - Dumb component version
import React from 'react';
import {ExternalLink, Wifi} from 'lucide-react';

export type PresentationConnectionStatus = 'disconnected' | 'connecting' | 'connected';
...
/**
 * Dumb presentation button component that only handles UI
 * All logic is handled by parent component through callbacks
 */
const PresentationButton: React.FC<PresentationButtonProps> = ({ 
    connectionStatus, 
    onOpenPresentation 
}) => {
