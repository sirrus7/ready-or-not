...
const TeamApp: React.FC = () => { // Renamed component from TeamDisplayPage
    ...
    const broadcastState = useTeamGameState({ // Renamed hook
        sessionId: sessionId || null,
        loggedInTeamId
    });

    // Decision submission logic
    const decisionSubmission = useTeamDecisionSubmission({ // Renamed hook
        sessionId: sessionId || null,
